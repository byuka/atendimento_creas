...
class TechniciansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create technician" do
    assert_difference('Technician.count') do
      post technicians_url, params: { technician: { cargo: @technician.cargo, data_nascimento: @technician.data_nascimento, matricula: @technician.matricula, nome: @technician.nome } }
    end
  ...
  test "should update technician" do
    patch technician_url(@technician), params: { technician: { cargo: @technician.cargo, data_nascimento: @technician.data_nascimento, matricula: @technician.matricula, nome: @technician.nome } }
